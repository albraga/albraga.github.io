<template>
  <div class="card">
    <h5 class="card-header">NMA</h5>
    <div class="card-body">
      <h5 class="card-title">Native Mobile Application</h5>
      <p class="card-text">
        Projetos em java para
        <a href="https://developer.android.com/" target="blank">Android</a>
      </p>
