<template>
    <div class="card">
            <h5 class="card-header">HMA</h5>
            <div class="card-body">
              <h5 class="card-title">Hybrid Mobile Application</h5>
              <p class="card-text">
                Projetos criados com <a href="https://cordova.apache.org/" target="blank">cordova</a>
              </p>
